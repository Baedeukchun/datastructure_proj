...
// Used in: Room.h to store Items and Monsters that belong to a room.
// Why: each room has a variable number of items/monsters, so a fixed array
//      would either waste space or overflow. A dynamic array doubles its
//      capacity when full, giving amortized O(1) append.
